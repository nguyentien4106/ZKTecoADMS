...
/// </summary>
[DeviceCommandStrategy(DeviceCommandTypes.UpdateEmployee)]
public class UpdateEmployeeStrategy(IRepository<Employee> employeeRepository) : IDeviceCommandStrategy
{
