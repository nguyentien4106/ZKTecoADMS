...
{
    public static ClockResponseModel ParseClockResponse(this string body)
    {
        var dict = body.Split('&')
        ...
        return new ClockResponseModel
        {
            ID = dict.TryGetValue("ID", out var idStr) && long.TryParse(idStr, out var id) ? id : 0,
