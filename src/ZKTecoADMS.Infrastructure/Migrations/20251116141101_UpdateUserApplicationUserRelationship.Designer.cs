...
namespace ZKTecoADMS.Infrastructure.Migrations
{
    ...
    [Migration("20251116141101_UpdateUserApplicationUserRelationship")]
    partial class UpdateUserApplicationUserRelationship
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ZKTecoADMS.Domain.Entities.User", b =>
                {
                    b.HasOne("ZKTecoADMS.Domain.Entities.ApplicationUser", "ApplicationUser")
                        .WithOne("User")
                        .HasForeignKey("ZKTecoADMS.Domain.Entities.User", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.SetNull);
